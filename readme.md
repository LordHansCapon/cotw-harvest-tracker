...
![Reserves](/assets/images/reserves.PNG)
...
![Harvests](/assets/images/harvests.PNG)
...
As of 2.0, on boot the Harvest Tracker will ask whether you want it to take screenshots of harvests automatically and place it to `screenshots/animals`.

Example for my Red Fox diamond which's ID is 67 (*as shown on the image of the previous section*):
![harvest images](/assets/images/animal-screenshot.png)
...
![Latest harvests](/assets/images/latest.PNG)
...
![Diamond checklist](/assets/images/diamond-checklist.PNG)
...
## Build
Build your own executables with Python! **Python3's version should not exceed 3.13!**
...
- Copy the `src\cotw-harvest-viewer\assets` and `src\cotw-harvest-tracker\assets` and place it inside the dist folder.
- We are done!

## Known Issues
As any software, this software also has flaws.
- As of 2.0, ff the tracker throws an error or closes, you have to restart the game aswell as the tracker as it is incapable of rehooking the game's memory correctly.
...
screenshot.wav sound effect:

Contarex camera shutter.wav by Tonik1105 -- https://freesound.org/s/520684/ -- License: Creative Commons 0
